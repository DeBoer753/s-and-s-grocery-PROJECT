...
// CSS
import styles from '../Cards/EyzaguirreSyrah.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling

// J LOHR SEVEN OAKS
const EyzaguirreSyrah = () => {
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Sausage<br />Hearty stew<br />Beef</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Rich<br />Tannic / Smooth<br />Earthy</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
...
export default EyzaguirreSyrah;