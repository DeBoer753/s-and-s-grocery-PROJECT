...
// CSS
import styles from '../Cards/BetterHalfSB.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/betterhalf_sb.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Better Half Sauvignon Blanc</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Discover the charm of Better Half Sauvignon Blanc, the perfect companion for any occasion. This vibrant wine bursts with refreshing notes of tropical fruit, citrus, and a hint of herbaceousness, creating a delightful and crisp taste experience. </p>
