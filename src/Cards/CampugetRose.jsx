...
// CSS
import styles from '../Cards/CampugetRose.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/campuget_rose.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Campuget Rose</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>A rose classic and an award winning wine. A glass of Campuget Rosé is perfect for warm summer afternoons, outdoor picnics, or casual gatherings with friends. Makes for a great drink after a long day of work too.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Salmon<br />Bell peppers<br />Brie cheese</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}> Costières de Nimes - Rhone, France</h5>
                                    </div>
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold / Light<br />Dry<br />Soft / Acidic</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
