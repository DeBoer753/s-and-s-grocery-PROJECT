...
// CSS
import styles from '../Cards/PoppyPinot.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/poppy_pinot.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Poppy Pinot Noir</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>As a top Poppy favorite by the public, Poppy Pinot Noir is the perfect choice for life's everyday moments and gatherings. Its smooth red fruit notes and balanced profile make it an easy companion for a casual brunch with friends or a quiet evening at home.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Creamy pasta<br />Roasted carrots<br />Gouda cheese</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>Monterey County, CA</h5>
                                    </div>
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Smooth<br />Dry<br />Bold / Light</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
